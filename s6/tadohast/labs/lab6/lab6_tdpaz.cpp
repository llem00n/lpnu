...
char cComPortName[] = "COM4"; // Name of the Serial port(May Change) to be opened,
wchar_t wComPortName[] = L"COM4"; // Name of the Serial port(May Change) to be opened,
BOOL Status;
...
int main()
{
    ...
    dcbSerialParams.BaudRate = CBR_128000; // baud rate
